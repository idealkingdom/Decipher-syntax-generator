function elementType(kind) {
    ...
    switch(kind){
		...
		case 'col':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<col label="r'+[i+1]+'">'+textsplit[i]+'</col>'+'\n');
				break
		case 'colV':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<col label="r'+[i+1]+'" value="'+[i+1]+'">'+textsplit[i]+'</col>'+'\n');
				break
		case 'colMatchv':
		    if (matchlabel[i]!= ''){
		...
		case 'choice':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<choice label="r'+[i+1]+'">'+textsplit[i]+'</choice>'+'\n');
				break
		case 'choiceV':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<choice label="r'+[i+1]+'" value="'+[i+1]+'">'+textsplit[i]+'</choice>'+'\n');
				break
		case 'choiceMatchv':
		    if (matchlabel[i]!= ''){
		...
		case 'group':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<group label="r'+[i+1]+'">'+textsplit[i]+'</group>'+'\n');
				break
		case 'groupV':
		    if (textsplit[i]!= '')
				editor.replaceSelection('<group label="r'+[i+1]+'" value="'+[i+1]+'">'+textsplit[i]+'</group>'+'\n');
				break
		case 'groupMatchv':
		    if (matchlabel[i]!= ''){
